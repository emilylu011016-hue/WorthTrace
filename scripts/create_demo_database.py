...
def anonymize_asset_category_labels(conn: sqlite3.Connection) -> None:
    labels = {
        "asset_cat_us_equity": "基金类别 A",
        "asset_sub_sp500": "基金子类 A",
        "asset_sub_nasdaq": "基金子类 B",
        "asset_sub_info_tech": "基金子类 C",
        "asset_sub_other_us": "基金子类 D",
        "asset_cat_dividend_low_vol": "基金类别 B",
        "asset_sub_dividend_low_vol": "基金子类 E",
        "asset_cat_bond": "债券",
